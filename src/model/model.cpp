...
void initBuffersGL(void)
{
  ...
  std::string vertex_shader_file("./src/model/vshader.glsl");
  std::string fragment_shader_file("./src/model/fshader.glsl");
  ...
  rod->change_parameters(2/s,0/s,0.1/s,0,0,110);
  for(int i=0;i<n;i++)
  {
...
void renderGL(void)
{
  ...
  glm::vec4 cc = glm::vec4(cc_xpos,cc_ypos, cc_zpos,1.0)*c_rotation_matrix;
